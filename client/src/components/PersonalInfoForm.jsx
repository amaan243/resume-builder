            ...
            {typeof data.image === 'object' && (
                <div className='flex flex-col gap-1 pl-4 text-sm'> 
                    ...
                    <label className='relative inline-flex items-center cursor-pointer  text-gray-900 gap-3'>
                        ...
                        <div className='w-9 h-5 bg-slate-300 rounded-full peer peer-checked:bg-[#1E3A8A] transition-colors duration-200'></div>
                ...
                <div key={field.key} className='space-y-1 mt-5'>
                    ...
                    <input 
                      ...
                      value={data[field.key] || ''} 
                        ...
                        className='mt-1 w-full border border-gray-300 rounded-lg px-3 py-2  focus:ring focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors text-sm'
