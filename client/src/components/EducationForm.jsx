  ...
  return (
   <div className='space-y-6'>
      <div className='flex items-center justify-between'>
        ...
        <button onClick={addEducation} className='flex items-center gap-2 px-3 py-1 text-sm bg-[#60A5FA]/20 text-[#1E3A8A] rounded-xl hover:bg-[#60A5FA]/30 transition-colors'>
            ...
            {data.map((education,index)=>(
                <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                    ...
                    <div className='grid  md:grid-cols-2 gap-3'>
                        ...
                        <input value={education.degree || ''} onChange={(e)=>updateEducation(index, 'degree', e.target.value)} type="text" placeholder="Degree (eg..Bachelor's or Master's)" className='px-3 py-2 text-sm '/>
